          ...
          <div className="grid gap-3 rounded-lg border border-stone-200 bg-stone-50 p-4">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="font-mono-brand mt-1 text-3xl font-semibold text-ink">
              ...
              >
                {recommendations.length > 0 ? (
                  ...
                  <EmptyState
                    ...
                    text="Watch or bid on a few auctions so BidLedger can suggest better picks."
                  />
                )}
              </Panel>
            </div>
...
const MiniMetric = ({ label, value }) => (
  <div className="rounded-md border border-stone-200 bg-white p-3">
    ...
    <p className="mt-1 text-lg font-mono-brand font-semibold text-ink">{value}</p>
  </div>
);
  ...
  <section className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm md:p-6">
    <div className="mb-4 flex items-center justify-between gap-3">
      ...
      {action && (
        <Link
          to={action.to}
          className="rounded-md bg-stone-100 px-3 py-2 text-sm font-semibold text-stone-600 transition hover:bg-brass/10 hover:text-brass-strong"
        >
          {action.label}
        </Link>
      )}
...
const AuctionRow = ({
  ...
  const toneClass = {
    emerald: "text-pine bg-pine-bg",
    rose: "text-rose-700 bg-rose-50",
    indigo: "text-brass-strong bg-brass/10",
  }[tone];
