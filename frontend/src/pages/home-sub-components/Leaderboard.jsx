  ...
  return (
    <>
      <section className="my-8">
          ...
          <table className="min-w-full">
            ...
            <tbody className="text-gray-700">
              {leaderboard.slice(0, 10).map((element, index) => {
                return (
                  <tr key={element._id} className="border-t border-stone-200">
                    ...
                    <td className="px-4 py-3 font-semibold text-brass-strong">
        ...
        <Link
          to={"/leaderboard"}
          className="mt-4 flex w-full justify-center rounded-md border border-stone-300 bg-white py-3 font-semibold text-slate-800 transition duration-200 hover:border-brass/40 hover:text-brass-strong"
        >
          Go to Leaderboard
        </Link>
      </section>
