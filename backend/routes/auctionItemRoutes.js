...
import { createAuctionValidation } from "../middlewares/validators.js";
import express from "express";
const router = express.Router();

router.post("/create", isAuth,isAuthorised("Auctioneer"),requireAuctioneerKyc,createAuctionValidation,addnewAuction);
